...
#endif
#if LINUX_VERSION_CODE < KERNEL_VERSION(3,7,0)
int __devinit tu_tu_ssv6xxx_sdio_probe(struct sdio_func *func,
        const struct sdio_device_id *id)
#else
int tu_tu_ssv6xxx_sdio_probe(struct sdio_func *func,
        const struct sdio_device_id *id)
#endif
{
    struct ssv6xxx_platform_data *pwlan_data;
 ...
 ssv6xxx_sdio_direct_int_mux_mode(glue, false);
    ...
    ret = tu_tu_ssv6xxx_dev_probe(glue->dev);
    if (ret)
    {
...
EXPORT_SYMBOL(tu_tu_ssv6xxx_sdio_probe);

#if LINUX_VERSION_CODE < KERNEL_VERSION(3,7,0)
void __devexit tu_tu_ssv6xxx_sdio_remove(struct sdio_func *func)
#else
void tu_tu_ssv6xxx_sdio_remove(struct sdio_func *func)
#endif
{
    struct ssv6xxx_sdio_glue *glue = sdio_get_drvdata(func);
    printk("tu_tu_ssv6xxx_sdio_remove..........\n");
    if ( glue )
    {
        printk("tu_tu_ssv6xxx_sdio_remove - ssv6xxx_sdio_irq_disable\n");
        ssv6xxx_sdio_irq_disable(&glue->core->dev,false);
        glue->dev_ready = false;
#if 0
        tu_tu_ssv6xxx_dev_remove(glue->dev);
#endif
  ssv6xxx_low_sdio_clk(func);
#ifdef CONFIG_FW_ALIGNMENT_CHECK
  if(glue->dmaSkb != NULL)
...
#endif
        printk("tu_tu_ssv6xxx_sdio_remove - disable mask\n");
        ssv6xxx_sdio_irq_setmask(&glue->core->dev,0xff);
    ...
    printk("tu_tu_ssv6xxx_sdio_remove leave..........\n");
}
EXPORT_SYMBOL(tu_tu_ssv6xxx_sdio_remove);

#ifdef CONFIG_PM
int tu_tu_ssv6xxx_sdio_suspend(struct device *dev)
{
...
EXPORT_SYMBOL(tu_tu_ssv6xxx_sdio_suspend);

int tu_tu_ssv6xxx_sdio_resume(struct device *dev)
{
    struct sdio_func *func = dev_to_sdio_func(dev);
    struct ssv6xxx_sdio_glue *glue = sdio_get_drvdata(func);
...
EXPORT_SYMBOL(tu_tu_ssv6xxx_sdio_resume);

static const struct dev_pm_ops ssv6xxx_sdio_pm_ops =
{
    .suspend = tu_tu_ssv6xxx_sdio_suspend,
    .resume = tu_tu_ssv6xxx_sdio_resume,
};
#endif
struct sdio_driver tu_tu_ssv6xxx_sdio_driver =
{
    .name = "TU_TU_SSV6XXX_SDIO",
    .id_table = ssv6xxx_sdio_devices,
    .probe = tu_tu_ssv6xxx_sdio_probe,
#if LINUX_VERSION_CODE < KERNEL_VERSION(3,7,0)
    .remove = __devexit_p(tu_tu_ssv6xxx_sdio_remove),
#else
    .remove = tu_tu_ssv6xxx_sdio_remove,
#endif
#ifdef CONFIG_PM
    .drv = {
...
EXPORT_SYMBOL(tu_tu_ssv6xxx_sdio_driver);
#if (defined(CONFIG_SSV_SUPPORT_ANDROID)||defined(CONFIG_SSV_BUILD_AS_ONE_KO))
int tu_tu_ssv6xxx_sdio_init(void)
#else
static int __init tu_tu_ssv6xxx_sdio_init(void)
#endif
{
    printk(KERN_INFO "tu_tu_ssv6xxx_sdio_init\n");
    return sdio_register_driver(&tu_tu_ssv6xxx_sdio_driver);
}
#if (defined(CONFIG_SSV_SUPPORT_ANDROID)||defined(CONFIG_SSV_BUILD_AS_ONE_KO))
void tu_tu_ssv6xxx_sdio_exit(void)
#else
static void __exit tu_tu_ssv6xxx_sdio_exit(void)
#endif
{
    printk(KERN_INFO "tu_tu_ssv6xxx_sdio_exit\n");
    sdio_unregister_driver(&tu_tu_ssv6xxx_sdio_driver);
}
#if (defined(CONFIG_SSV_SUPPORT_ANDROID)||defined(CONFIG_SSV_BUILD_AS_ONE_KO))
EXPORT_SYMBOL(tu_tu_ssv6xxx_sdio_init);
EXPORT_SYMBOL(tu_tu_ssv6xxx_sdio_exit);
#else
module_init(tu_tu_ssv6xxx_sdio_init);
module_exit(tu_tu_ssv6xxx_sdio_exit);
#endif
MODULE_LICENSE("GPL");
