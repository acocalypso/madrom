...
struct ssv6xxx_cfg tu_tu_ssv_cfg;
EXPORT_SYMBOL(tu_tu_ssv_cfg);
#if 0
...
static int __string2configuration(u8 *mac_str, void *val, u32 arg)
{
    ...
    {
        if(tu_tu_ssv_cfg.configuration[i][0] == 0x0)
        {
            tu_tu_ssv_cfg.configuration[i][0] = address;
            tu_tu_ssv_cfg.configuration[i][1] = value;
            return 0;
        }
    }
    return 0;
}
struct ssv6xxx_cfg_cmd_table tu_tu_cfg_cmds[] = {
    { "hw_mac", (void *)&tu_tu_ssv_cfg.maddr[0][0], 0, __string2mac , NULL},
    { "hw_mac_2", (void *)&tu_tu_ssv_cfg.maddr[1][0], 0, __string2mac , NULL},
    { "def_chan", (void *)&tu_tu_ssv_cfg.def_chan, 0, __string2u32 , "6"},
    { "hw_cap_ht", (void *)&tu_tu_ssv_cfg.hw_caps, 0, __string2flag32 , "on"},
    { "hw_cap_gf", (void *)&tu_tu_ssv_cfg.hw_caps, 1, __string2flag32 , "off"},
    { "hw_cap_2ghz", (void *)&tu_tu_ssv_cfg.hw_caps, 2, __string2flag32 , "on"},
    { "hw_cap_5ghz", (void *)&tu_tu_ssv_cfg.hw_caps, 3, __string2flag32 , "off"},
    { "hw_cap_security", (void *)&tu_tu_ssv_cfg.hw_caps, 4, __string2flag32 , "on"},
    { "hw_cap_sgi", (void *)&tu_tu_ssv_cfg.hw_caps, 5, __string2flag32 , "on"},
    { "hw_cap_ht40", (void *)&tu_tu_ssv_cfg.hw_caps, 6, __string2flag32 , "on"},
    { "hw_cap_ap", (void *)&tu_tu_ssv_cfg.hw_caps, 7, __string2flag32 , "on"},
    { "hw_cap_p2p", (void *)&tu_tu_ssv_cfg.hw_caps, 8, __string2flag32 , "on"},
    { "hw_cap_ampdu_rx", (void *)&tu_tu_ssv_cfg.hw_caps, 9, __string2flag32 , "on"},
    { "hw_cap_ampdu_tx", (void *)&tu_tu_ssv_cfg.hw_caps, 10, __string2flag32 , "on"},
    { "hw_cap_tdls", (void *)&tu_tu_ssv_cfg.hw_caps, 11, __string2flag32 , "off"},
    { "hw_cap_stbc", (void *)&tu_tu_ssv_cfg.hw_caps, 12, __string2flag32 , "on"},
    { "hw_cap_hci_rx_aggr", (void *)&tu_tu_ssv_cfg.hw_caps, 13, __string2flag32 , "on"},
    { "hw_beacon", (void *)&tu_tu_ssv_cfg.hw_caps, 14, __string2flag32 , "on"},
    { "use_wpa2_only", (void *)&tu_tu_ssv_cfg.use_wpa2_only, 0, __string2u32 , NULL},
    { "wifi_tx_gain_level_gn",(void *)&tu_tu_ssv_cfg.wifi_tx_gain_level_gn, 0, __string2u32 , NULL},
    { "wifi_tx_gain_level_b", (void *)&tu_tu_ssv_cfg.wifi_tx_gain_level_b, 0, __string2u32 , NULL},
    { "xtal_clock", (void *)&tu_tu_ssv_cfg.crystal_type, 0, __string2u32 , "24"},
    { "volt_regulator", (void *)&tu_tu_ssv_cfg.volt_regulator, 0, __string2u32 , "0"},
    { "firmware_path", (void *)&tu_tu_ssv_cfg.firmware_path[0], 0, __string2str , NULL},
    { "flash_bin_path", (void *)&tu_tu_ssv_cfg.flash_bin_path[0], 0, __string2str , NULL},
    { "mac_address_path", (void *)&tu_tu_ssv_cfg.mac_address_path[0], 0, __string2str , NULL},
    { "mac_output_path", (void *)&tu_tu_ssv_cfg.mac_output_path[0], 0, __string2str , NULL},
    { "ignore_efuse_mac", (void *)&tu_tu_ssv_cfg.ignore_efuse_mac, 0, __string2u32 , NULL},
    { "efuse_rate_gain_mask", (void *)&tu_tu_ssv_cfg.efuse_rate_gain_mask, 0, __string2u32 , "0x1"},
    { "mac_address_mode", (void *)&tu_tu_ssv_cfg.mac_address_mode, 0, __string2u32 , NULL},
    { "register", NULL, 0, __string2configuration, NULL},
    { "beacon_rssi_minimal", (void *)&tu_tu_ssv_cfg.beacon_rssi_minimal, 0, __string2u32 , NULL},
    { "force_chip_identity", (void *)&tu_tu_ssv_cfg.force_chip_identity, 0, __string2u32 , NULL},
    { "external_firmware_name", (void *)&tu_tu_ssv_cfg.external_firmware_name[0], 0, __string2str, NULL},
    { "ignore_firmware_version", (void *)&tu_tu_ssv_cfg.ignore_firmware_version, 0, __string2u32, NULL},
    { "use_sw_cipher", (void *)&tu_tu_ssv_cfg.use_sw_cipher, 0, __string2u32, NULL},
    { "rc_ht_support_cck", (void *)&tu_tu_ssv_cfg.rc_ht_support_cck, 0, __string2u32 , "1"},
    { "auto_rate_enable", (void *)&tu_tu_ssv_cfg.auto_rate_enable, 0, __string2u32 , "1"},
    { "rc_rate_idx_set", (void *)&tu_tu_ssv_cfg.rc_rate_idx_set, 0, __string2u32 , "0x7777"},
    { "rc_retry_set", (void *)&tu_tu_ssv_cfg.rc_retry_set, 0, __string2u32 , "0x4444"},
    { "rc_mf", (void *)&tu_tu_ssv_cfg.rc_mf, 0, __string2u32 , NULL},
    { "rc_long_short", (void *)&tu_tu_ssv_cfg.rc_long_short, 0, __string2u32 , NULL},
    { "rc_ht40", (void *)&tu_tu_ssv_cfg.rc_ht40, 0, __string2u32 , NULL},
    { "rc_phy_mode" , (void *)&tu_tu_ssv_cfg.rc_phy_mode, 0, __string2u32 , "3"},
 { "tx_id_threshold" , (void *)&tu_tu_ssv_cfg.tx_id_threshold, 0, __string2u32 , NULL},
 { "tx_page_threshold" , (void *)&tu_tu_ssv_cfg.tx_page_threshold, 0, __string2u32 , NULL},
 { "max_rx_aggr_size", (void *)&tu_tu_ssv_cfg.max_rx_aggr_size, 0, __string2u32 , "64"},
 { "online_reset", (void *)&tu_tu_ssv_cfg.online_reset, 0, __string2u32 , "0x00f"},
 { "rx_burstread", (void *)&tu_tu_ssv_cfg.rx_burstread, 0, __string2bool , "0"},
    { "hw_rx_agg_cnt", (void *)&tu_tu_ssv_cfg.hw_rx_agg_cnt, 0, __string2u32 , "3"},
 { "hw_rx_agg_method_3", (void *)&tu_tu_ssv_cfg.hw_rx_agg_method_3, 0, __string2bool , "0"},
 { "hw_rx_agg_timer_reload", (void *)&tu_tu_ssv_cfg.hw_rx_agg_timer_reload, 0, __string2u32 , "20"},
 { "usb_hw_resource", (void *)&tu_tu_ssv_cfg.usb_hw_resource, 0, __string2u32 , "0"},
 { "tx_stuck_detect", (void *)&tu_tu_ssv_cfg.tx_stuck_detect, 0, __string2bool , "0"},
 { "clk_src_80m", (void *)&tu_tu_ssv_cfg.clk_src_80m, 0, __string2bool , "1"},
 { "rts_thres_len", (void *)&tu_tu_ssv_cfg.rts_thres_len, 0, __string2u32 , "0"},
    { "cci", (void *)&tu_tu_ssv_cfg.cci, 0, __string2u32 , "0x19"},
    { "bk_txq_size", (void *)&tu_tu_ssv_cfg.bk_txq_size, 0, __string2u32 , "6"},
    { "be_txq_size", (void *)&tu_tu_ssv_cfg.be_txq_size, 0, __string2u32 , "10"},
    { "vi_txq_size", (void *)&tu_tu_ssv_cfg.vi_txq_size, 0, __string2u32 , "10"},
    { "vo_txq_size", (void *)&tu_tu_ssv_cfg.vo_txq_size, 0, __string2u32 , "8"},
    { "manage_txq_size", (void *)&tu_tu_ssv_cfg.manage_txq_size, 0, __string2u32 , "8"},
    { "aggr_size_sel_pr", (void *)&tu_tu_ssv_cfg.aggr_size_sel_pr, 0, __string2u32 , "95"},
    { "aging_period", (void *)&tu_tu_ssv_cfg.rc_setting.aging_period,0, __string2u32 , "2000"},
    { "target_success_67", (void *)&tu_tu_ssv_cfg.rc_setting.target_success_67, 0, __string2u32 , "55"},
    { "target_success_5", (void *)&tu_tu_ssv_cfg.rc_setting.target_success_5 , 0, __string2u32 , "78"},
    { "target_success_4", (void *)&tu_tu_ssv_cfg.rc_setting.target_success_4 , 0, __string2u32 , "70"},
    { "target_success", (void *)&tu_tu_ssv_cfg.rc_setting.target_success , 0, __string2u32 , "50"},
    { "up_pr", (void *)&tu_tu_ssv_cfg.rc_setting.up_pr, 0, __string2u32 , "70"},
    { "up_pr3", (void *)&tu_tu_ssv_cfg.rc_setting.up_pr3, 0, __string2u32 , "85"},
    { "up_pr4", (void *)&tu_tu_ssv_cfg.rc_setting.up_pr4, 0, __string2u32 , "97"},
    { "up_pr5", (void *)&tu_tu_ssv_cfg.rc_setting.up_pr5, 0, __string2u32 , "70"},
    { "up_pr6", (void *)&tu_tu_ssv_cfg.rc_setting.up_pr6, 0, __string2u32 , "70"},
    { "forbid", (void *)&tu_tu_ssv_cfg.rc_setting.forbid, 0, __string2u32 , "0"},
    { "forbid3", (void *)&tu_tu_ssv_cfg.rc_setting.forbid3, 0, __string2u32 , "0"},
    { "forbid4", (void *)&tu_tu_ssv_cfg.rc_setting.forbid4, 0, __string2u32 , "350"},
    { "forbid5", (void *)&tu_tu_ssv_cfg.rc_setting.forbid5, 0, __string2u32 , "100"},
    { "forbid6", (void *)&tu_tu_ssv_cfg.rc_setting.forbid6, 0, __string2u32 , "0"},
    { "sample_pr_4", (void *)&tu_tu_ssv_cfg.rc_setting.sample_pr_4, 0, __string2u32 , "70"},
    { "sample_pr_5", (void *)&tu_tu_ssv_cfg.rc_setting.sample_pr_5, 0, __string2u32 , "85"},
    { "sample_pr_force", (void *)&tu_tu_ssv_cfg.rc_setting.force_sample_pr, 0, __string2u32 , "40"},
    { "greentx", (void *)&tu_tu_ssv_cfg.greentx, 0, __string2u32 , "0x119"},
    { "gt_stepsize", (void *)&tu_tu_ssv_cfg.gt_stepsize, 0, __string2u32 , "3"},
    { "gt_max_attenuation", (void *)&tu_tu_ssv_cfg.gt_max_attenuation, 0, __string2u32 , "15"},
    { "autosgi", (void *)&tu_tu_ssv_cfg.auto_sgi, 0, __string2u32 , "0x1"},
    { "directly_ack_low_threshold" ,(void *)&tu_tu_ssv_cfg.directly_ack_low_threshold, 0, __string2u32 , "64"},
    { "directly_ack_high_threshold",(void *)&tu_tu_ssv_cfg.directly_ack_high_threshold, 0, __string2u32 , "1024"},
    { "txrxboost_prio", (void *)&tu_tu_ssv_cfg.txrxboost_prio, 0, __string2u32 , "20"},
    { "txrxboost_low_threshold",(void *)&tu_tu_ssv_cfg.txrxboost_low_threshold, 0, __string2u32 , "64"},
    { "txrxboost_high_threshold",(void *)&tu_tu_ssv_cfg.txrxboost_high_threshold, 0, __string2u32 , "256"},
    { "rx_threshold", (void *)&tu_tu_ssv_cfg.rx_threshold, 0, __string2u32 , "64"},
    { "force_xtal_fo", (void *)&tu_tu_ssv_cfg.force_xtal_fo, 0, __string2u32 , NULL},
    { "disable_dpd", (void *)&tu_tu_ssv_cfg.disable_dpd, 0, __string2u32 , "0"},
    { "mic_err_notify", (void *)&tu_tu_ssv_cfg.mic_err_notify, 0, __string2u32 , "0"},
    { "domain", (void *)&tu_tu_ssv_cfg.domain, 0xff, __string2u32 , NULL},
    { NULL, NULL, 0, NULL, NULL},
};
EXPORT_SYMBOL(tu_tu_cfg_cmds);
static int ssv_cmd_cfg(struct ssv_softc *sc, int argc, char *argv[])
{
    int s;
    struct ssv_cmd_data *cmd_data = &sc->cmd_data;
    if ((argc == 2) && (strcmp(argv[1], "reset") == 0)) {
        memset(&tu_tu_ssv_cfg, 0, sizeof(tu_tu_ssv_cfg));
        return 0;
    } else if ((argc == 2) && (strcmp(argv[1], "show") == 0)) {
        snprintf_res(cmd_data, ">> ssv6xxx config:\n");
        snprintf_res(cmd_data, "    hw_caps = 0x%08x\n", tu_tu_ssv_cfg.hw_caps);
        snprintf_res(cmd_data, "    def_chan = %d\n", tu_tu_ssv_cfg.def_chan);
        snprintf_res(cmd_data, "    wifi_tx_gain_level_gn = %d\n", tu_tu_ssv_cfg.wifi_tx_gain_level_gn);
        snprintf_res(cmd_data, "    wifi_tx_gain_level_b = %d\n", tu_tu_ssv_cfg.wifi_tx_gain_level_b);
        snprintf_res(cmd_data, "    sta-mac = %02x:%02x:%02x:%02x:%02x:%02x",
            tu_tu_ssv_cfg.maddr[0][0], tu_tu_ssv_cfg.maddr[0][1], tu_tu_ssv_cfg.maddr[0][2],
            tu_tu_ssv_cfg.maddr[0][3], tu_tu_ssv_cfg.maddr[0][4], tu_tu_ssv_cfg.maddr[0][5]);
        snprintf_res(cmd_data, "\n");
        return 0;
    }
    if (argc != 4)
        return -1;
    for(s = 0; tu_tu_cfg_cmds[s].cfg_cmd != NULL; s++) {
        if (strcmp(tu_tu_cfg_cmds[s].cfg_cmd, argv[1]) == 0) {
            tu_tu_cfg_cmds[s].translate_func(argv[3],
                tu_tu_cfg_cmds[s].var, tu_tu_cfg_cmds[s].arg);
            snprintf_res(cmd_data, "");
            return 0;
        }
    }
