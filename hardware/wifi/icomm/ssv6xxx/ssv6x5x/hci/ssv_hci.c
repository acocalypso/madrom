...
bool tu_tu_ssv6xxx_hci_init_debugfs(struct ssv6xxx_hci_ctrl *ctrl_hci, struct dentry *dev_deugfs_dir)
{
...
#ifdef CONFIG_SSV6XXX_DEBUGFS
    .hci_init_debugfs = tu_tu_ssv6xxx_hci_init_debugfs,
...
int tu_tu_ssv6xxx_hci_deregister(struct ssv6xxx_hci_info *shi)
{
    u32 regval;
...
EXPORT_SYMBOL(tu_tu_ssv6xxx_hci_deregister);
int tu_tu_ssv6xxx_hci_register(struct ssv6xxx_hci_info *shi)
{
    int i, capability;
    struct ssv6xxx_hci_ctrl *hci_ctrl;
    if (shi == NULL ) {
...
EXPORT_SYMBOL(tu_tu_ssv6xxx_hci_register);
#if (defined(CONFIG_SSV_SUPPORT_ANDROID)||defined(CONFIG_SSV_BUILD_AS_ONE_KO))
int tu_tu_ssv6xxx_hci_init(void)
#else
int __init tu_tu_ssv6xxx_hci_init(void)
#endif
{
...
#if (defined(CONFIG_SSV_SUPPORT_ANDROID)||defined(CONFIG_SSV_BUILD_AS_ONE_KO))
void tu_tu_ssv6xxx_hci_exit(void)
#else
void __exit tu_tu_ssv6xxx_hci_exit(void)
#endif
{
#ifdef CONFIG_SSV6200_CLI_ENABLE
#endif
...
#if (defined(CONFIG_SSV_SUPPORT_ANDROID)||defined(CONFIG_SSV_BUILD_AS_ONE_KO))
EXPORT_SYMBOL(tu_tu_ssv6xxx_hci_init);
EXPORT_SYMBOL(tu_tu_ssv6xxx_hci_exit);
#else
module_init(tu_tu_ssv6xxx_hci_init);
module_exit(tu_tu_ssv6xxx_hci_exit);
#endif
