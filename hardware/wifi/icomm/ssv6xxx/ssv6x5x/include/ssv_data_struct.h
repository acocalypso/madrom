...
static inline void tu_tu_ssv6xxx_init_queue(struct ssv6xxx_queue *ssv_queue) {
    INIT_LIST_HEAD(&ssv_queue->queue);
    spin_lock_init(&ssv_queue->lock);
}
static inline void tu_tu_ssv6xxx_init_list_node(struct ssv6xxx_list_node *node) {
