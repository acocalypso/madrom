...
$(call inherit-product, device/khadas/kvim/product/product.mk)
...
PRODUCT_COPY_FILES += \
    $(ANDROID_BUILD_TOP)/hardware/wifi/icomm/ssv6xxx/ssv6051/firmware/ssv6051-sw.bin:system/etc/wifi/ssv6051/ssv6051-sw.bin

PRODUCT_COPY_FILES += \
    $(ANDROID_BUILD_TOP)/hardware/wifi/icomm/ssv6xxx/ssv6051/firmware/ssv6051-wifi.cfg:system/etc/wifi/ssv6051/ssv6051-wifi.cfg
