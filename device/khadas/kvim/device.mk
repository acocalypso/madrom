...
PRODUCT_COPY_FILES += \
     device/khadas/kvim/preinstall/put_some_apks_here:system/preinstall/put_some_apks_here

## put some axtra stuff into the image
# init.d example
PRODUCT_COPY_FILES += \
     device/khadas/kvim/preinstall/99RebootLog:system/etc/init.d/99RebootLog

# curl
PRODUCT_COPY_FILES += \
     device/khadas/kvim/preinstall/curl:system/bin/curl
PRODUCT_COPY_FILES += \
     device/khadas/kvim/preinstall/libcrypto.so.1.1:system/lib64/libcrypto.so.1.1
PRODUCT_COPY_FILES += \
     device/khadas/kvim/preinstall/libnghttp2.so:system/lib64/libnghttp2.so
PRODUCT_COPY_FILES += \
     device/khadas/kvim/preinstall/libssl.so.1.1:system/lib64/libssl.so.1.1
