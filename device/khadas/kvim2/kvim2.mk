...
$(call inherit-product, device/khadas/kvim2/product/product.mk)
$(call inherit-product, device/khadas/kvim2/device.mk)
...
PRODUCT_AML_SECUREBOOT_USERKEY := ./uboot/board/khadas/kvim2/aml-user-key.sig
...
ifeq ($(BUILD_WITH_DM_VERITY), true)
PRODUCT_COPY_FILES += \
    device/khadas/kvim2/fstab.AB.verity.amlogic:root/fstab.amlogic
else
PRODUCT_COPY_FILES += \
    device/khadas/kvim2/fstab.AB.amlogic:root/fstab.amlogic
endif
else
ifeq ($(BUILD_WITH_DM_VERITY), true)
PRODUCT_COPY_FILES += \
    device/khadas/kvim2/fstab.verity.amlogic:root/fstab.amlogic
else
PRODUCT_COPY_FILES += \
    device/khadas/kvim2/fstab.amlogic:root/fstab.amlogic
endif
endif
